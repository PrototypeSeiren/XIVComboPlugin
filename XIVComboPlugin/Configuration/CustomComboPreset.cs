...
namespace XIVComboPlugin
{
    ...
    public enum CustomComboPreset : long
    {
        ...
        // DRAGOON
        [CustomComboInfo("跳跃 - 幻象冲", "当处于幻象冲预备状态下，替换跳跃为幻象冲", 22, new uint[]{ DRG.Jump, DRG.HighJump })]
        DragoonJumpFeature = 1L << 44,

        [CustomComboInfo("苍天龙血 - 坠星冲", "当处于红莲龙血状态下,替换苍天龙血为坠星冲", 22, new uint[] { DRG.BOTD })]
        DragoonBOTDFeature = 1L << 46,

        [CustomComboInfo("山境酷刑连击", "替换山境酷刑为相应的连击", 22, new uint[] { DRG.CTorment })]
        DragoonCoerthanTormentCombo = 1L << 0,

        [CustomComboInfo("樱花怒放连击", "替换樱花怒放为相应的连击", 22, new uint[] { DRG.ChaosThrust })]
        ...
        [CustomComboInfo("强力射击 - 直线射击", "当触发时，替换强力射击/爆发射击为直线射击/辉煌箭", 23, new uint[] { BRD.HeavyShot, BRD.BurstShot })]
